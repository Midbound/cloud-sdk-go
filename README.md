...
<a href="https://pkg.go.dev/github.com/stainless-sdks/midbound-cloud-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/midbound-cloud-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Midbound Cloud Go library provides convenient access to the [Midbound Cloud REST API](https://midbound.cloud)
...
```go
import (
	"github.com/stainless-sdks/midbound-cloud-go" // imported as midboundcloud
)
```
...
```sh
go get -u 'github.com/stainless-sdks/midbound-cloud-go@v0.0.1'
```
...
The midboundcloud library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/midbound-cloud-go/option).
...
`*midboundcloud.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `midboundcloud.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/midbound-cloud-go/issues) with questions, bugs, or suggestions.
